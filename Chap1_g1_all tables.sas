...
IF GEST_WK2 <20 AND GT 47 THEN DELETE;
...
/*By race-ethnicty*/
PROC FREQ DATA = livefnh1;
TABLES (SAM_MAGE SAM_meduc SAM_Feduc SAM_married SAM_Kessner sam_sex)*RACEHISP;
...
RUN;
/*Table 2 - PTB race by race and ethnicity*/
...
/*Regresssion tables - unadjusted and adjusted*/
