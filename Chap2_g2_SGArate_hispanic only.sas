...
/*Using ethnicity from generation 2 to see SGA Rates*/

	IF M_HISP EQ 0 AND M_RACE EQ 1 THEN RACEHISP_CAT = 0; /*NH WHITE*/
	ELSE IF M_HISP EQ 0 AND M_RACE EQ 2 THEN RACEHISP_CAT = 1; /*NH BLACK*/
	ELSE IF M_HISP EQ 1 AND M_RACE EQ 1 THEN RACEHISP_CAT = 2; /*WHITE MEXICAN*/
	ELSE IF M_HISP EQ 1 AND M_RACE EQ 2 THEN RACEHISP_CAT = 3; /*MEXICAN BLACK*/
	ELSE IF M_HISP EQ 2 AND M_RACE EQ 1 THEN RACEHISP_CAT = 4; /*WHITE PUERTO RICAN*/
	ELSE IF M_HISP EQ 2 AND M_RACE EQ 2 THEN RACEHISP_CAT = 5; /*BLACK PR*/
	ELSE IF M_HISP EQ 3 AND M_RACE EQ 1 THEN RACEHISP_CAT = 6; /*WHITE CUBAN*/
	ELSE IF M_HISP EQ 3 AND M_RACE EQ 2 THEN RACEHISP_CAT = 7; /*BLACK CUBAN*/
	ELSE IF M_HISP EQ 4 AND M_RACE EQ 1 THEN RACEHISP_CAT = 8; /*WHITE CA*/
	ELSE IF M_HISP EQ 4 AND M_RACE EQ 2 THEN RACEHISP_CAT = 9; /*BLACK CA*/
	ELSE IF M_HISP EQ 5 AND M_RACE EQ 1 THEN RACEHISP_CAT = 10; /*OTHER*/
	ELSE IF M_HISP EQ 5 AND M_RACE EQ 2 THEN RACEHISP_CAT = 11; /*Hispanic*/


	IF M_HISP EQ 0 THEN HISP_CAT = 0; /*NH*/
	ELSE IF M_HISP EQ 1 THEN HISP_CAT = 1; /*MEXICAN*/
	ELSE IF M_HISP EQ 2 THEN HISP_CAT = 2; /*Puerto Rican*/
	ELSE IF M_HISP EQ 3 THEN HISP_CAT = 3; /*Cuban*/
	ELSE IF M_HISP EQ 4 THEN HISP_CAT = 4; /*Central or SA*/
	ELSE IF M_HISP IN (5,9) THEN HISP_CAT = 5; /*Other or unk*/
	ELSE HISP_CAT = 6; /*Missing*/
...
MAT_meduc = .;
  ...
  else if 15 < M_EDU < 18 then MAT_meduc = 5;
  else MAT_meduc = 6;
...
MAT_Feduc = .;
  ...
  else if 15 < F_EDU < 18 then MAT_Feduc = 5;
  else MAT_Feduc = 6;

MAT_Feduc3 = .;
  IF 0 <= F_EDU < 12 THEN MAT_Feduc3 = 1;
  else if F_EDU eq 12 THEN MAT_Feduc3 = 2; 
  else if 12 < F_EDU < 18 then MAT_Feduc3 = 3;
  else MAT_Feduc3 = 4;
...
SAM_meduc = .;
  ...
  else if 15 < SAM_EDUMOM < 18 then SAM_meduc = 5;
  else SAM_meduc = 6;
RUN;
...
/**WNH*/
PROC FREQ DATA = LINK4;
TABLES SGAWF_G2 * ( MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among white females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGAWF_G2 * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among white females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
/**BNH*/
PROC FREQ DATA = LINK4;
TABLES SGABF_G2 * ( MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among black females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGABF_G2 * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among black females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
/***hisp***/
PROC FREQ DATA = LINK4;
TABLES SGAHF_G2 * (MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among hisp females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGAHF_G2 * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among hisp females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
ODS TAGSETS.EXCELXP
file='C:\Users\njain\Documents\Personal\Dissertation\Diss_workingfolder\Analysis\SGA\Chapter 2 -SGA\Output\MEANBWT_G2.xls'
STYLE=minimal
OPTIONS ( Orientation = 'landscape' 
FitToPage = 'yes'
Pages_FitWidth = '1'
...
PROC means DATA = LINK4;
class GEST_WK2 racehisp;
var BIRTHWT_F2;
RUN;
...
/**WNH*/
PROC FREQ DATA = LINK4;
TABLES SGAWM * ( MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among white females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGAWM * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among white females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
/**BNH*/
PROC FREQ DATA = LINK4;
TABLES SGABM * ( MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among black females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGABM * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among black females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
/***hisp***/
PROC FREQ DATA = LINK4;
TABLES SGAHM * (MAT_meduc MAT_Feduc MAT_Kessner )/trend measures cl;
TITLE "SGA among hisp females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES SGAHM * (MAT_married MAT_LBW MAT_MAGE6  )/CHISQ ;
TITLE "SGA among hisp females between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
