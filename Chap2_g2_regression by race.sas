...
MODEL SGAWF_G2 = MAT_MAGE6;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_meduc(param=ref ref="4"); 
MODEL SGAWF_G2 = MAT_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class SAM_meduc(param=ref ref="4");
MODEL SGAWF_G2 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Feduc(param=ref ref="4"); 
MODEL SGAWF_G2 = MAT_Feduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_married (param=ref ref="0"); 
MODEL SGAWF_G2 =  MAT_married;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Kessner(param=ref ref="1"); 
MODEL SGAWF_G2 =  MAT_Kessner;
RUN; 
/*FINAL MODEL WNH WITHOUT GRANDMOM*/
...
MODEL SGAWF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc MAT_married MAT_Kessner;
RUN;

/*FINAL MODEL WNH WITH GRANDMOM*/
...
class MAT_MAGE6(param=ref ref="3") 
	  ...
	  MAT_Kessner (param=ref ref="1");;
MODEL SGAWF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc SAM_meduc MAT_married MAT_Kessner;
RUN;
...
PROC LOGISTIC DATA = LINK4 descending;
class MAT_MAGE6(param=ref ref="3"); 
MODEL SGABF_G2 = MAT_MAGE6;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_meduc(param=ref ref="4"); 
MODEL SGABF_G2 = MAT_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class SAM_meduc(param=ref ref="4");
MODEL SGABF_G2 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Feduc(param=ref ref="4"); 
MODEL SGABF_G2 = MAT_Feduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_married (param=ref ref="0"); 
MODEL SGABF_G2 =  MAT_married;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Kessner(param=ref ref="1"); 
MODEL SGABF_G2 =  MAT_Kessner;
RUN; 
/*FINAL MODEL WNH WITHOUT GRANDMOM*/
...
class MAT_MAGE6(param=ref ref="3") 
	  ...
	  MAT_Feduc (param=ref ref="4")
  	  MAT_Kessner (param=ref ref="1");
MODEL SGABF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc MAT_married MAT_Kessner;
RUN;
...
class MAT_MAGE6(param=ref ref="3") 
	  ...
	  MAT_Feduc (param=ref ref="4")
  	  SAM_meduc (param=ref ref="4")
	  MAT_Kessner (param=ref ref="1");;
MODEL SGABF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc SAM_meduc MAT_married MAT_Kessner;
RUN;
...
PROC LOGISTIC DATA = LINK4 descending;
class MAT_MAGE6(param=ref ref="3"); 
MODEL SGAHF_G2 = MAT_MAGE6;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_meduc(param=ref ref="4"); 
MODEL SGAHF_G2 = MAT_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class SAM_meduc(param=ref ref="4");
MODEL SGAHF_G2 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Feduc(param=ref ref="4"); 
MODEL SGAHF_G2 = MAT_Feduc;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_married (param=ref ref="0"); 
MODEL SGAHF_G2 =  MAT_married;
RUN; 
PROC LOGISTIC DATA = LINK4 descending;
class MAT_Kessner(param=ref ref="1"); 
MODEL SGAHF_G2 =  MAT_Kessner;
RUN; 
/*FINAL MODEL WNH WITHOUT GRANDMOM*/
...
class MAT_MAGE6(param=ref ref="3") 
	  ...
	  MAT_Feduc (param=ref ref="4")
  	  MAT_Kessner (param=ref ref="1");
MODEL SGAHF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc MAT_married MAT_Kessner;
RUN;
...
class MAT_MAGE6(param=ref ref="3") 
	  ...
	  MAT_Feduc (param=ref ref="4")
  	  SAM_meduc (param=ref ref="4")
	  MAT_Kessner (param=ref ref="1");;
MODEL SGAHF_G2 = MAT_MAGE6 MAT_meduc MAT_Feduc SAM_meduc MAT_married MAT_Kessner;
RUN;
