...
PROC FREQ DATA = LINK5;
TABLES PTB_CAT*mat_meduc3; *Col percent;
TABLES mat_meduc3*PTB_CAT; *row percent;
run;

/*BY RACE & ETHNICITY for PTB*/

PROC FREQ DATA = LINK5;
TABLES (MAT_LBW)*mat_meduc3/chisq;
WHERE PTB_CAT EQ 1;
TITLE "Grandmothers Low birthweight by race among women delivering between 1979-1983";
FORMAT SAM_LBW PTB_CAT fy1n0x.;
RUN;
PROC FREQ DATA = LINK5;
TABLES (MAT_Kessner)*mat_meduc3/chisq;
WHERE PTB_CAT EQ 1;
TITLE "Mothers Kessner's Index of adequacy of prenatal care by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. MAT_Kessner fKessner. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK5;
TABLES (MAT_married)*mat_meduc3/chisq;
WHERE PTB_CAT EQ 1;
TITLE "Mothers MARITAL by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. ;
RUN;
PROC FREQ DATA = LINK5;
TABLES (MAT_Feduc)*mat_meduc3/chisq;
WHERE PTB_CAT EQ 1;;
TITLE "Fathers education by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. SAM_Feduc feduc6x.;
RUN;
PROC FREQ DATA = LINK5;
TABLES (MAT_MAGE6)*mat_meduc3/chisq;
WHERE PTB_CAT EQ 1;;
TITLE "Fathers education by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. SAM_Feduc feduc6x.;
RUN;
...
RUN;
PROC FREQ DATA = LINK4;
TABLES MAT_MAGE6*SGAWF_G2;
TABLES MAT_MAGE6*SGABF_G2;
TABLES MAT_MAGE6*SGAHF_G2;
TITLE "Materanl age by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES MAT_Kessner*SGAWF_G2;
TABLES MAT_Kessner*SGABF_G2;
TABLES MAT_Kessner*SGAHF_G2;
TITLE "Mothers Kessner's Index of adequacy of prenatal care by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. MAT_Kessner fKessner. PTB_CAT fy1n0x.;;
RUN;
PROC FREQ DATA = LINK4;
TABLES MAT_meduc*SGAWF_G2;
TABLES MAT_meduc*SGABF_G2;
TABLES MAT_meduc*SGAHF_G2;
TITLE "Mothers education by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. MAT_meduc feduc6x.;
RUN;
PROC FREQ DATA = LINK4;
TABLES MAT_married*SGAWF_G2;
TABLES MAT_married*SGABF_G2;
TABLES MAT_married*SGAHF_G2;
TITLE "Mothers MARITAL by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. ;
RUN;
PROC FREQ DATA = LINK4;
TABLES MAT_Feduc*SGAWF_G2;
TABLES MAT_Feduc*SGABF_G2;
TABLES MAT_Feduc*SGAHF_G2;
TITLE "Fathers education by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. SAM_Feduc feduc6x.;
RUN;

PROC FREQ DATA = LINK4;
TABLES SAM_meduc*SGAWF_G2;
TABLES SAM_meduc*SGABF_G2;
TABLES SAM_meduc*SGAHF_G2;
TITLE "Mothers education by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. MAT_meduc feduc6x.;
RUN;
