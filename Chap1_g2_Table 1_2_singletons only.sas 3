...
MAT_Kessner = 2;
  if MAT_COMBGEST=99 or MAT_COMBGEST=. or MNTH_PREN_CARE =. or
     NUM_PREN_CARE  =. then MAT_Kessner = 4;
...
PROC FREQ DATA = LINK4;TABLES racehisp;RUN;
/**sga**/
...
TABLES (MAT_PTB4 MAT_meduc MAT_Feduc MAT_married MAT_LBW MAT_MAGE6 MAT_Kessner)*RACEHISP;
...
RUN;
PROC FREQ DATA = LINK5;
TABLES PTB_CAT * (MAT_married MAT_MAGE6  )/CHISQ ;
WHERE RACEHISP EQ 2;
TITLE "Mothers Low birthweight by race among women delivering between 1999-2011";
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
...
RUN;
PROC FREQ DATA = LINK5;
TABLES PTB_CAT * (MAT_married MAT_MAGE6)/trend measures cl;
WHERE RACEHISP EQ 0 AND SEX EQ '1';
FORMAT RACEHISP fmrace. MAT_LBW fy1n0x. PTB_CAT fy1n0x.;;
RUN;
/**WNH FOR FEMALES*/
