...
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_Feduc(param=ref ref="3"); 
where RACEHISP EQ 2;
MODEL PTB_CAT = SAM_Feduc;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_married (param=ref ref="1"); 
where RACEHISP EQ 2;
MODEL PTB_CAT =  SAM_married;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_Kessner(param=ref ref="1"); 
where RACEHISP EQ 2;
MODEL PTB_CAT =  SAM_Kessner;
RUN; 
...
where RACEHISP EQ 0;
MODEL PTB_CAT =  SAM_meduc RACEHISP;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_meduc (param=ref ref="4")
	  SAM_MAGE3(param=ref ref="3");
where RACEHISP EQ 0;
MODEL PTB_CAT = SAM_meduc SAM_MAGE3;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_meduc (param=ref ref="4")
	  SAM_Feduc param=ref ref="4");
where RACEHISP EQ 0;
MODEL PTB_CAT =  SAM_meduc SAM_Feduc;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class  SAM_meduc (param=ref ref="4");
where RACEHISP EQ 0;
MODEL PTB_CAT = SAM_meduc SAM_married;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_meduc (param=ref ref="3")
	  SAM_Kessner(param=ref ref="1"); 	  
MODEL PTB_CAT = SAM_meduc SAM_Kessner;
RUN; 
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_meduc (param=ref ref="3");
MODEL PTB_CAT = SAM_meduc SAM_LBW;
RUN;
/*final model*/
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_MAGE3(param=ref ref="3") 
	  ...
	  SAM_Kessner (param=ref ref="1")
	  SAM_MARRIED (param=ref ref="1");
where RACEHISP EQ 0;
MODEL PTB_CAT = SAM_MAGE3 SAM_meduc SAM_Feduc SAM_married  SAM_Kessner;
RUN; 
/*final model*/
PROC LOGISTIC DATA = livefnh1 descending;
class SAM_MAGE3(param=ref ref="3") 
...
class SAM_MAGE3(param=ref ref="3") 
	  ...
	  SAM_Kessner (param=ref ref="1");
where RACEHISP EQ 0;
MODEL PTB_CAT1 = SAM_meduc SAM_MAGE3 SAM_married SAM_Feduc SAM_Kessner;
RUN; 
