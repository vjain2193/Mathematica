...
SAM_meduc3 = .;
  ...
  else if '12' < SAM_EDUMOM < '19' then SAM_meduc3 = 2;
  else SAM_meduc3 = 3;

 SAM_feduc3 = .;
  IF 0 <= SAM_EDUDAD < 12 THEN SAM_Feduc3 = 1;
  else if SAM_EDUDAD eq '12' THEN SAM_Feduc3 = 2; 
  else if '12' < SAM_EDUDAD < '19' then SAM_Feduc3 = 3;
  else SAM_Feduc3 = 4;
...
SAM_meduc = .;
  ...
  else if '15' < SAM_EDUMOM < '19' then SAM_meduc = 5;
  else SAM_meduc = 6;
...
SAM_Feduc = .;
  ...
  else if '15' < SAM_EDUDAD < '19' then SAM_Feduc = 5;
...
/*************Regression analysis for WNH****************/

PROC LOGISTIC DATA = BIN_REG descending;
class SAM_MAGE3(param=ref ref="3"); 
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 = SAM_MAGE3;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_meduc(param=ref ref="4"); 
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Feduc(param=ref ref="4"); 
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 = SAM_Feduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_married (param=ref ref="0"); 
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 =  SAM_married;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_LBW (param=ref ref="0");
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 =  SAM_LBW;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Kessner(param=ref ref="1"); 
where RACEHISP EQ 2;
MODEL SGA_WNHF_G1 =  SAM_Kessner;
RUN; 

/*************Regression analysis for BNH****************/

PROC LOGISTIC DATA = BIN_REG descending;
class SAM_MAGE3(param=ref ref="3"); 
where RACEHISP EQ 1;
MODEL SGA_BNHFG1 = SAM_MAGE3;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_meduc(param=ref ref="4"); 
MODEL SGA_BNHFG1 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Feduc(param=ref ref="4"); 
MODEL SGA_BNHFG1 = SAM_Feduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_married (param=ref ref="0"); 
MODEL SGA_BNHFG1 =  SAM_married;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_LBW (param=ref ref="0");
MODEL SGA_BNHFG1 =  SAM_LBW;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Kessner(param=ref ref="1"); 
MODEL SGA_BNHFG1 =  SAM_Kessner;
RUN; 

/*************Regression analysis for NH****************/

PROC LOGISTIC DATA = BIN_REG descending;
class SAM_MAGE3(param=ref ref="3"); 
MODEL SGA_NHFG1 = SAM_MAGE3;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_meduc(param=ref ref="4"); 
MODEL SGA_NHFG1 = SAM_meduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Feduc(param=ref ref="4"); 
MODEL SGA_NHFG1 = SAM_Feduc;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_married (param=ref ref="0"); 
MODEL SGA_NHFG1 =  SAM_married;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_LBW (param=ref ref="0");
MODEL SGA_NHFG1 =  SAM_LBW;
RUN; 
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_Kessner(param=ref ref="1"); 
MODEL SGA_NHFG1 =  SAM_Kessner;
RUN; 
...
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 = SAM_meduc SAM_MAGE3 SAM_married SAM_Feduc SAM_Kessner;
RUN; 
...
class SAM_MAGE3(param=ref ref="3") 
	  ...
	  SAM_Kessner (param=ref ref="1");
where RACEHISP EQ 1;
MODEL SGA_BNHFG1 = SAM_MAGE3 SAM_meduc SAM_Feduc SAM_married  SAM_Kessner;
RUN; 
...
class SAM_MAGE3(param=ref ref="3") 
	  ...
	  SAM_Kessner (param=ref ref="1");
where RACEHISP EQ 2;
MODEL SGA_NHFG1 = SAM_meduc SAM_MAGE3 SAM_married SAM_Feduc SAM_Kessner;
RUN; 
...
class SAM_MAGE3(param=ref ref="3") 
	  ...
	  SAM_Feduc (param=ref ref="4");
where RACEHISP EQ 0;
MODEL SGA_WNHF_G1 = SAM_MAGE3 SAM_meduc SAM_Feduc SAM_married ;
RUN;
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_MAGE3(param=ref ref="3") 
	  SAM_meduc (param=ref ref="4")
	  SAM_Feduc (param=ref ref="4");
where RACEHISP EQ 1;
MODEL PTB_CAT1 = SAM_MAGE3 SAM_meduc SAM_Feduc SAM_married ;
RUN;
PROC LOGISTIC DATA = BIN_REG descending;
class SAM_MAGE3(param=ref ref="3") 
	  SAM_meduc (param=ref ref="4")
...
/*final model without kessner and no missing*/
